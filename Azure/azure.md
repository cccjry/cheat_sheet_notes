...
IaaS 將最大的責任交給了您。 雲端提供者負責維護實體基礎結構及其網際網路的存取權。 您必須負責安裝和設定、修補和更新，以及安全性。
...
PaaS 會劃分您與雲端提供者之間的責任。 雲端提供者負責維護實體基礎結構及其網際網路的存取權，就像在 Iaas 中一樣。 在 PaaS 模型中，雲端提供者也會維護作業系統、資料庫和開發工具。 您可以把 PaaS 想像成在使用已加入網域的電腦：IT 會透過定期更新、修補和重新整理來維護裝置。
...
- [Azure官方學習資源](https://learn.microsoft.com/zh-tw/training/browse/) ：測驗詳情請至網站